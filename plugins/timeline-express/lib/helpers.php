...
function timeline_express_get_announcement_icon_markup( $post_id, $link = true ) {
	...
	?>
		<?php $announcement_colour = timeline_express_get_announcement_icon_color( $post_id ); ?>
		<?php $font_colour = $announcement_colour === '#ffffff' ? '#bfbfbf' : '#ffffff' ?>
		<div class="cd-timeline-img cd-picture<?php echo esc_attr( $icon_container_class ); ?>" style="background:<?php echo $announcement_colour; ?>;">
			...
			<?php } else { ?>
				...
				<!-- Standard Font Awesome Icon -->
				<span class="fa <?php echo esc_attr( timeline_express_get_announcement_icon( $post_id ) ); ?>" title="<?php echo esc_attr( get_the_title( $post_id ) ); ?>" style="color:<?php echo $font_colour; ?>"></span>
